...
// Outputs for NSG IDs (needed for flow logs)
output spoke1NsgId string = spoke1Nsg.id
output spoke2NsgId string = spoke2Nsg.id
...
output workloadVnetId string = workloadVnet.id
